...
- 中国碳市场机构与企业名录：集中链接国家能源局、生态环境部、国家气候战略中心、应对气候变化司、认证和交易登记机构；企业名录采用北京市生态环境局、北京市统计局发布的 2024 年官方名单，共 1291 家，可按类别、行业和所属区检索。该名录与每日新闻档案分开维护，不会覆盖历史语料。
...
- 分类体系：气候与能源记录统一补充 ISO 3166-1 二字母、三字母国别代码，并按“联合国与气候机制、全球经济与政策协调、区域合作机制、国际能源机构”四组标注 G20、COP、UNFCCC、APEC、G7、ASEAN、IEA、IRENA、SCO、BRICS、EU、AU、CPTPP 与 OECD；COP 届次从文本动态提取，不写死年份。

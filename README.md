...
- 企业情报：仅在“能源技术”模式显示。企业目录现有 1,000 余家可追溯记录：基础层要求具备国家、行业和企业官网，来源为 Wikidata 结构化字段；深度层对重点企业补充经财报或官网核验的营收、利润、核心技术、项目和发展方向。站内新闻另识别“能源巨头项目、能源初创企业、企业合作”三类动态；企业地图可切换今日队列和本周。地图优先采用新闻明确地点，缺失时才使用已核验的企业总部位置。目录不声称穷尽全球全部企业，也不估算未披露财务数据。
- 企业深度档案：重点企业增加业务概况、财年与币种明确的营收和利润、核心技术、重点项目、发展方向及官方财报入口。上市公司使用年度报告口径；未公开可比财务数据的初创企业明确标注“未公开”，不作估算。
- 能源报告：能源模式提供 200 余份近三年重点报告，可按标题、国家或组织、年份和主题检索。目录覆盖政府、国际组织、研究机构、行业智库和专业协会；批量基础目录采用世界银行 Documents & Reports 官方元数据并保留英文原题、正式页面或全文链接，编辑精选补充 IEA、IRENA、EIA、欧盟、主要国家及权威产业机构报告。每日任务继续扫描正式发布源，新报告只有通过中文标题、HTTPS 原文、年份与报告类型门禁后才增量入库；项目进度表、采购文件、审计附件等不纳入统计。

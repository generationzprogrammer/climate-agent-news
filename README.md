...
- 能源报告：能源模式提供约 200 份近三年重点报告，可按标题、国家或组织、年份和主题检索。目录覆盖政府、国际组织、研究机构、行业智库和专业协会；批量基础目录采用世界银行 Documents & Reports 官方元数据并保留英文原题、正式页面或全文链接，编辑精选补充 IEA、IRENA、EIA、欧盟、主要国家及权威产业机构报告。每日任务继续扫描正式发布源，新报告只有通过简体中文可读标题、HTTPS 原文、年份与报告类型门禁后才增量入库；项目进度表、采购文件、审计附件和损坏翻译不纳入统计。

...
- 专题页包括京津冀绿色转型、新能源、储能技术和人工智能数据中心。每日发布时从已通过质量门禁的气候与能源档案中增量匹配，不另行调用模型或新闻 API。
...
- “情报认知地图”展示国家与议题共现关系及今日关键词；能源模式的转型追踪器展示近一年语料中的政策、项目、技术、电网储能和投融资信号。图表反映本平台样本，不等同于官方排名或未来预测。
